...
console.log("");
console.log("```bash");
console.log(`npm install --global @bigking67/pi-67@${version}`);
console.log("pi-67 install");
console.log("```");
console.log("");
console.log("## Update");
console.log("");
console.log("```bash");
console.log("pi-67 self-update");
console.log("pi-67 update --check --json");
console.log("pi-67 update");
console.log("```");
console.log("");
console.log("Legacy Git workspaces must preview and run `pi-67 migrate --yes` once.");
console.log("");
