...
[ -f "$REPO_ROOT/scripts/pi67-sync-ai-berkshire-skill-pack.sh" ] || fail "missing scripts/pi67-sync-ai-berkshire-skill-pack.sh"
[ -f "$REPO_ROOT/scripts/pi67-sync-ai-berkshire-skill-pack.mjs" ] || fail "missing scripts/pi67-sync-ai-berkshire-skill-pack.mjs"
[ -f "$REPO_ROOT/scripts/pi67-test-ai-berkshire-skill-pack.sh" ] || fail "missing scripts/pi67-test-ai-berkshire-skill-pack.sh"
...
section "Summary"
bash "$REPO_ROOT/scripts/pi67-test-ai-berkshire-skill-pack.sh"
pass "AI Berkshire Pack generator, provenance, fail-closed, and active-sync contracts passed"
